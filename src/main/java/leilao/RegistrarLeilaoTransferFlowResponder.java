...
@InitiatedBy(RegistrarLeilaoFlowInitiator.class)
public class RegistrarLeilaoTransferFlowResponder extends FlowLogic<Void> {
    ...
    public RegistrarLeilaoTransferFlowResponder(FlowSession counterpartySession) {
