...
@InitiatedBy(CadastrarItemFlowInitiator.class)
public class CadastrarItemTransferFlowResponder extends FlowLogic<Void> {
    ...
    public CadastrarItemTransferFlowResponder(FlowSession counterpartySession) {
